...
const COLUMN_LABELS: Record<string, string> = {
  ...
  player_name: "Player",
  pointstreak_game_id: "Game ID",
  pointstreak_player_id: "Player ID",
  pitching_order: "PO",
  position: "POS",
  ...
  strikeouts: "SO",
  team: "Team",
  team_pointstreak_link_id: "Team ID",
  team_pointstreak_id: "Season Team ID",
  teams: "Teams",
  ties: "T",
  triples: "3B",
  type: "Type",
...
const COLUMN_DESCRIPTIONS: Record<string, string> = {
  ...
  pointstreak_game_id: "Pointstreak Game Identifier",
  pointstreak_player_id: "Stable Pointstreak Player Identifier",
  ...
  score: "Final Score",
  season_id: "Pointstreak Season Identifier",
  ...
  team: "Team",
  team_pointstreak_link_id: "Stable Pointstreak Team Link Identifier",
  team_pointstreak_id: "Season-Scoped Pointstreak Team Identifier",
  teams: "Teams",
  ties: "Ties",
  triples: "Triples",
  type: "Type",
